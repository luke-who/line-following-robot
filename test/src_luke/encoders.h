...
volatile long count_encdr_r; // used by encoder to count the rotation   //right encoder (CPR)
volatile byte state_encdr_r;                                            //right encoder
volatile long count_encdr_l;                                            //left encoder (CPR)
volatile byte state_encdr_l;                                            //left encoder
...
ISR( INT6_vect ) {
  ...
  // State:  new B   new A   old B   old A
    state_encdr_r = state_encdr_r | ( e0_B  << 3 );
    state_encdr_r = state_encdr_r | ( e0_A  << 2 );
    ...
    if( state_encdr_r == 0 ) {
      //no change
    } else if( state_encdr_r == 1 || state_encdr_r == 7 || state_encdr_r == 8 || state_encdr_r == 14) {
      count_encdr_r-=1; // forwards
    } else if( state_encdr_r == 2 || state_encdr_r == 4 || state_encdr_r == 11 || state_encdr_r == 13) {
      count_encdr_r+=1; // backwards
...
ISR( PCINT0_vect ) {
    ...
    state_encdr_l = state_encdr_l | ( e1_B  << 3 );
    state_encdr_l = state_encdr_l | ( e1_A  << 2 );
    ...
    if( state_encdr_l == 0 ) {
      //no change
    } else if( state_encdr_l == 1 || state_encdr_l == 7 || state_encdr_l == 8 || state_encdr_l == 14) {
      count_encdr_l-=1;
    } else if( state_encdr_l == 2 || state_encdr_l == 4 || state_encdr_l == 11 || state_encdr_l == 13) {
      count_encdr_l+=1;
    } // Continue this if statement as necessary.
